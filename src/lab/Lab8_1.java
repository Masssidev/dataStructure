...
class ProducerThread extends Thread {
	private SynchronizedQueue queue;//큐 인스턴스변수

	public ProducerThread(SynchronizedQueue queue) {//생성자
		this.queue = queue;
	}
...
class ConsumerThread extends Thread {
	private SynchronizedQueue queue;//큐 인스턴스 변수

	public ConsumerThread(SynchronizedQueue queue) {//생성자
		this.queue = queue;
	}
